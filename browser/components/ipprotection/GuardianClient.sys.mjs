...
export class GuardianClient {
  ...
  async isLinkedToGuardian() {
    ...
    const cached_clients =
      await lazy.fxAccounts.listAttachedOAuthcached_Clients();
 ...
 */
function waitUntilURL(browser, predicate) {
  return new Promise(resolve => {
    ...
    wp.addProgressListener(listener, Ci.nsIWebProgress.NOTIFY_LOCATION);
  });
}
