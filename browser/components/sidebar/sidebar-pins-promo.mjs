...
export default class SidebarPinsPromo extends MozLitElement {
  ...
  #icons = [
    "chrome://browser/skin/firefox.svg",
    "chrome://browser/skin/slack.svg",
    "chrome://browser/skin/foxy-light.svg",
    "chrome://browser/skin/foxy-dark.svg",
    "chrome://browser/skin/gmail.svg",
  ];
  ...
  render() {
    ...
    return html` <link
      ...
      <moz-button
        ...
        @click=${lazy.SidebarManager.dismissDragToPinPromo}
        size="small"
        type="icon ghost"
      >
      </moz-button>`;
